...
namespace WizardParams
{
	...
	const ::Spell[] spells = 
	{
		...
		Spell("magic_missile", "BROKEN SPELL DO NOT USE", 17, "THIS SPELL IS BROKEN, WE'RE TRYING TO FIND A FIX FOR IT. IT'S NAME WAS MAGIC MISSILES.",
			SpellType::other, 151, 10, 3, 360.0f, true),
