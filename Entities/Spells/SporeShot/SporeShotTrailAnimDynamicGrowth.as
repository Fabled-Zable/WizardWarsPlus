//Orb trail animation
const f32 initialSize = 3.4f;
const f32 scaleFactor = 0.9f;
const u8 maxScale = 400;

void onInit( CSprite@ this )
{
	this.SetZ( 500.0f );
    CSpriteLayer@ trail = this.addSpriteLayer( "trail", "SporeShotTrail.png", 11, 7 );
	if (trail !is null)
    {
...
void onTick( CSprite@ this )
{
	...
	if ( this.isAnimation( "static" ) )//set by GooBall.as
	{
		...
		this.ScaleBy( Vec2f( scale * 29.0f, scale ) );
